            ...
            <div className="flex flex-col self-center gap-6">
              <div>
                ...
                <p>
                  ...
                  dapur (yang layak), sebaiknya tetap menjaga bahwa yang
                  dimasukkan sesuai yang telah direkomendasikan agar tidak
                  mengganggu proses komposting yang dimasukkan sebelumnya.
                </p>
              </div>
              <div>
                <h3 className="text-base-content text-xl font-semibold">
