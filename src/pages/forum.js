...
const initialPosts = [
  {
    ...
    comments: [
      { id: 1, author: 'Ani Wijaya', content: 'Terima kasih tipsnya!', date: '2024-03-15' },
      { id: 2, author: 'Dewi Putri', content: 'Sangat membantu!', date: '2024-03-16' },
    ]
  },
  {
    id: 2,
    ...
    tag: 'bertanya',
    date: '2024-03-14',
    content: 'Saya sudah mencoba membuat kompos tapi hasilnya berbau tidak sedap...',
    comments: [
      { id: 1, author: 'Rudi Hartono', content: 'Mungkin terlalu banyak bahan basah', date: '2024-03-14' },
    ]
  },
];
...
export default function Forum() {
  ...
  const [newPost, setNewPost] = useState({ title: '', content: '', tag: 'berbagi' });
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {showNewPostForm && (
          <div className="bg-white p-6 rounded-lg shadow-md mb-8">
            ...
            <form onSubmit={isEditing ? handleEditSubmit : handleNewPostSubmit} className="space-y-4">
              <div>
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  post.tag === 'berbagi' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                }`}>
                  {post.tag}
                </span>
              </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Oleh: {selectedPost.author}</p>
                    <p className="text-sm text-gray-500">{selectedPost.date}</p>
                  </div>
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    selectedPost.tag === 'berbagi' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                  }`}>
                    {selectedPost.tag}
                  </span>
                </div>
