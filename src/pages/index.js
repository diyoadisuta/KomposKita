  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta name="description" content="Platform rekomendasi kompos dan komunitas composting" />
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-10 md:mb-0">
                ...
                <p className="text-xl mb-8">
                  Temukan solusi kompos yang tepat untuk kebutuhan Anda dengan rekomendasi yang dipersonalisasi
                </p>
                <Link 
                  href="/rekomendasi" 
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between">
              <div className="md:w-1/2 mb-10 md:mb-0">
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Diskusikan pengalaman composting Anda, ajukan pertanyaan, dan berbagi pengetahuan dengan komunitas composting Indonesia
                </p>
                <Link 
                  href="/forum" 
