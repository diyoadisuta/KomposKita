    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">KomposKita</h3>
            <p className="text-gray-300">
              Platform edukasi dan komunitas untuk pengelolaan sampah organik melalui komposting.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/rekomendasi" className="text-gray-300 hover:text-white">
